...
TAG_TO_FOLDER = {
    ...
    "Assign practice recommendations activities": "Assign practice recommendations activities",
    "Manage Classes": "Manage Classes"
}

# --- Load main summary, determine top 4/5 tags ---
# Discover CSV (allow it to live in the Aug-Sep 2025 subfolder)
possible_csvs = glob.glob(os.path.join(os.getcwd(), '**', 'custom_chart_2025-08-25_2025-09-26.csv'), recursive=True)
if not possible_csvs:
    raise FileNotFoundError('Could not find custom_chart_2025-08-25_2025-09-26.csv in the workspace')
